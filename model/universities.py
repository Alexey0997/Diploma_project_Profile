"""Модуль, реализующий класс Universities (ВУЗы), наследуемый от класса Scientists."""
from model.scientists import Scientists


class Universities(Scientists):
    """Конструктор класса Universities, в котором:
    ...
    def __init__(self, id_stakeholders, name, birth_date, position, viewpoint):
        super().__init__(kind_influence="образование")
