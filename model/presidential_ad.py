"""Модуль, реализующий класс PresidentialAdministration (Админ. Президента), наследуемый от класса Leadership."""
from model.leadership import Leadership


class PresidentialAdministration(Leadership):
    """Конструктор класса PresidentialAdministration, в котором:
    ...
    def __init__(self, id_stakeholders, name, birth_date, position, viewpoint):
        super().__init__(kind_influence="администрация пр.")
