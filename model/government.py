"""Модуль, реализующий класс Government (правительство), наследуемый от класса Leadership."""
from model.leadership import Leadership


class Government(Leadership):
    """Конструктор класса Government, в котором:
    ...
    def __init__(self, id_stakeholders, name, birth_date, position, viewpoint):
        super().__init__(kind_influence="правительство")
