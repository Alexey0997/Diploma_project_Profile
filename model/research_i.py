"""Модуль, реализующий класс ResearchInstitutesk (НИИ), наследуемый от класса Scientists."""
from model.scientists import Scientists


class ResearchInstitutes(Scientists):
    """Конструктор класса ResearchInstitutes, в котором:
    ...
    def __init__(self, id_stakeholders, name, birth_date, position, viewpoint):
        super().__init__(kind_influence="наука")
