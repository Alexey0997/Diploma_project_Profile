"""Модуль, реализующий класс ThinkTank (Исследовательский Центр), наследуемый от класса Scientists."""
from model.scientists import Scientists


class ThinkTank(Scientists):
    """Конструктор класса ThinkTank, в котором:
    ...
    def __init__(self, id_stakeholders, name, birth_date, position, viewpoint):
        super().__init__(kind_influence="исслед. центр")
